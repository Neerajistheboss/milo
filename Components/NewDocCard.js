...
const NewDocCard=(props)=>{
    ...
    const [docPhoto,setDocPhoto]=useState('https://i.ibb.co/P4WYMnD/doctor.png')
    ...
    return(
        <TouchableOpacity onPress={handleBookNow}  style={{position:'relative',display:'flex',flexDirection:'column',alignItems:'flex-start',justifyContent:'center',marginTop:10,minHeight:200,borderRadius:10,backgroundColor:"#FFF",width:'95%',marginLeft:'auto',marginRight:'auto',padding:10}}>
            <View style={{display:'flex',width:'90%',flexDirection:'row',marginTop:5,marginBottom:30}}>
            {docPhoto&& <Image source={{uri:docPhoto}} style={{width:75,height:75,borderColor:'blue',borderRadius:50,borderWidth:1,resizeMode:'cover',marginRight:10}} />
            }
                <View >
