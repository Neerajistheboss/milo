        ...
        return (
           // <NavigationContainer>
              <Drawer.Navigator initialRouteName="Home">
                ...
                <Drawer.Screen options={{title: 'Logout',drawerIcon:({focused,size})=>(<Ionicons name='log-out-outline' size={18} style={{margin:0}} />)}} name="Logout" component={HomeStackNavigator} />
               </Drawer.Navigator>
            //</NavigationContainer>
    )
